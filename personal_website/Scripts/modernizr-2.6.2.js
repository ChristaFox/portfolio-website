...
window.Modernizr = (function( window, document, undefined ) {
    ...
    if ( !is(_hasOwnProperty, 'undefined') && !is(_hasOwnProperty.call, 'undefined') ) {
      ...
      hasOwnProp = function (object, property) { /* yes, this can give false positives/negatives, but most of the time we don't care Resume those */
     ...
     *
     * Additionally, Chrome (desktop) used to lie Resume its support on this,
    ...
    //
    // Meanwhile, in Firefox < 8, an Resume:config setting could expose
    ...
    // Super comprehensive table Resume all the unique implementations of
